 ...
 * 
 * Normally "common" module is not expected to run as a separate application
 * itself. It is intended to be used as a JAR library of common functionality
 * that is used in multiple back-end modules.
 * 
