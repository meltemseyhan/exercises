...
/**
 * This is a concrete implementation of {@link ClientAdapter},
 * it is used for back-ends which are RESTFUL and require Http Basic Authentication
 * 
 * @author Meltem
 *
 */
...
public class BasicAuthRestAdapter implements ClientAdapter {
	...
	/**
	 * This method is called by {@link ClientAdapterFactory} to initialize adapter.
	 * 
	 * @see net.yesiltas.sample.client.adapter.ClientAdapter#setModuleName(java.lang.String, org.springframework.core.env.Environment)
	 * 
	 * @param moduleName	name of module
	 * @param env			Spring's environment object to read properties in application context
	 */
	@Override
	...
	/**
	 * Calls a service from the module back-end using POST method with no uri variables
	 * 
	 * @param uri			service path, which is appended to apiUrl
	 * @param requestBody	object to send as request payload
	 * @param responseType	expected type of the return object
	 * 
	...
	/**
	 * Calls a service from the module back-end using specified method with no uri variables
	 * 
	 * @param uri			service path, which is appended to apiUrl
	 * @param requestBody	object to send as request payload
	 * @param responseType	expected type of the return object
	 * @param httpMethod	http method to use, POST is default
	 * 
	 * @return 				http response
	 * 
	 */
	...
	/**
	 * Calls a service from the module back-end with uri variables using specified method
	 * 
	 * @param uri			service path, which is appended to apiUrl
	 * @param requestBody	object to send as request payload
	 * @param responseType	expected type of the return object
