...
/**
 * This class tells the spring boot to start a web application. Since client
 * project uses model classes from the other server modules, and since those
 * classes are annotated with JPA annotations, client project depends JPA
 * related libraries to compile.
 * <p>
 ...
 * <p>
 * But Client project should not depend on any database, it is merely for
 * serving the UI.
 * <p>
 * To prevent Spring from loading JPA, related configuration classes are
 * excluded. This way project compiles, model classes are reused, and client
 * project is free from database dependency.
 * 
 * @author Meltem
 */
